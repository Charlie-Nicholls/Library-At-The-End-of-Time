...
<span class="sub2">:FasCircleQuestion: Museum</span>

---

> [!recite|clean no-t]
>	A three-story marble edifice stands before you, frosted with sculptures and scrollwork. Columns flank the broad frontage like bars of an enormous cage.
>^IntroText
...
### Area 1: Foyer
> [!recite|clean no-t]
>	Decorative pillars extend the length of this imposing marble entryway. A semicircular arch frames the doorway at the end of the hall, and embellished panels decorate the ceiling. Anattendant sells tickets to the museum at a desk on the western wall of the foyer.
>^Area1
...
> [!recite|clean no-t]
>	Just behind the glass, the air shimmers faintly, like oil on water.
>^Forcecage

### Area 3: Arms of Saint Sergia
> [!recite|clean no-t]
...
### Area 4: Arcane Calligraphy
> [!recite|clean no-t]
>	Shadowboxes line the double hallway of this gallery. Each box contains parchment painted with elegant arcane runes. A large table takes up the center of the room. There is a set of unmarked double doors on the north wall and a sphinx statue next to them.
>^Area4

On examining the table:

> [!recite|clean no-t]
>	The table in the center of the room holds an open tome underneath protective glass. A circular sigil fills the pages, all concentric rings and glyphs. The sigil is slashed through with ink, breaking the complex lines. A plaque on the display reads "Conjuration rune, deactivated."
>^Area4table

- The exhibits in this room are similar to the runes that protect the museum.
...
### Area 6: Library
> [!recite|clean no-t]
>	Business like bookshelves fill this wide, low-ceilinged room, filled with files and plainly bound books.
>^Area6

- The museum stores reference material here. The subject matter is dry and technical.
- There is a 50% chance that [[Luca Lomeo]] is here.
- If characters spend ten minutes searching the shelves, they may roll an Intelligence (Investigation) check to see what information they discover about the museum.
	- 0-10: Nothing.
	- 11-16: Book describing the three primary enchantments that protect the museum, *forcecage*, *private sanctum*, and *magic circle*. Allow players to read the full text for each spell.
	- 17+: The book above and a second record that details the location of each spell rune.
...
- [[Dr Carda Halftusk]] keeps the key to this door in her office.
- The interior set of double doors is not locked

### Area 7b: Archives(R)
> [!recite|clean no-t]
>	Complete darkness greets you. The air smells stale and sweet.
>^Area7b

- The archives are enchanted with a permanent darkness spell, impenetrable even to creatures with darkvision. 
- Any source of light lasts for 1 round before being snuffed out. Light sources can be re-lit or re-cast, lasting for one round each time. 
- The password *lux et veritas* lifts the darkness 8 enchantment for ten minutes. [[Dr Carda Halftusk]] and [[Luca Lomeo]] know this password. 
- In the brief light, you see walls made of sliding steel drawers of sizes to hold everything from matchboxes to coffins. The stacks of drawers on the edges of the room are only five feet lower than the ceiling. Ten-foot high steel drawers line the walls of the room, leaving a five-foot gap to the ceiling above them. On the western and southern sides of the room, walls of drawers go all the way up to the ceiling and extend into the center of the room.
- There is a *forcecage* rune carved into the southeastern wall above the ledge of drawers.
- The exterior walls of the room are five feet thick and enchanted to repel *passwall* and other means of magical bypass. The locks on all of the drawers are enchanted with individual *alarm* spells. They make a loud ringing sound when opened with DC 25 Dexterity (Sleight of Hand) check with thieves' tools instead of with a key.
...
>^Area8
 ...
 - When the players enter this room for the first time, [[Rinaldo Bardi]] is harassing the guard. 
	 ...
	 - He only gave it a chance as a favour to his uncle, the museum director. 
	 - Shortly after the players appear, another guard barely controlling their temper escorts Rinaldo out of the museum.

### Area 9: Tapestry Art
> [!recite|clean no-t]
>	 Carpet-sized tapestries hang from gold rods behind panes of glass. The bright fabrics depict banquets, hunting parries and landscapes in isometric perspective.
>^Area9
...
> [!recite|clean no-t]
>	 A circular glyph, two feet in diameter, is carved into the stone. The circle is split into three sections. Traces of red/blue/green sparkle in the grooves of the carving.
>^Area11ForcecageRune
...
- Underneath the table is the *magic circle* rune. If players examine the table:

> [!recite|clean no-t]
>	Underneath the quartz tabletop, there is a large five pointed star carved into the wood. Complex lines cross over all of the symbols and the points of the star.
>^Area12MagicCircle

- The museum's magic circle rune is carved into the wooden surface of the central table. The tabletop is completely covered with a thick sheet of quartz.
- The sheet requires a collective Strength score of 25 to lift. 
- If the magic circle rune is deactivated, [[The Trickster]] can enter the museum. He can give advantage on all Charisma checks made in his presence. 
...
- Dr. Halftusk keeps keys to the [[#Area 7b Archives(R)|Archive]] locked in the top drawer of her desk. This drawer can be unlocked with a successful DC 15 Dexterity check using thieves' tools.
- Players who inspect the bookshelf may make the same Intelligence (Investigation) check offered in the [[#Area 6 Library|Library]] to gain the same possible information.
...
- In the afternoon on the first day, Dr. Halftusk gives a free lecture on the history of jewellery design. She shows off several pieces from the Archives as part of her lecture. She is happy to talk with students after the seminar.
...
- Characters with a Passive Perception of 15 or higher notice the rune. Any character who takes a moment to observe the ceiling sees the rune as well. 
- There are no guards in this part of the museum, but the café is always busy. Accomplishing a task covertly requires a DC 18 Dexterity (Stealth) check to avoid catching the attention of one of the many lunching guests.
