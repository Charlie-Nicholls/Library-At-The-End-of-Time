...
locations:
  - "[[Sword Coast]]"
displayLink: "[[Baldurs Gate#Baldurs Gate]]"
---
...
FROM "Compendium/NPCs" AND [[Baldurs Gate]]
SORT file.name ASC
>
>> [!example]- LOCATIONS
>>```dataview
LIST WITHOUT ID displayLink
FROM "Compendium/Atlas/Material Plane/Toril/Faerûn/Western Heartlands/The Sword Coast/Baldurs Gate"  AND [[Baldurs Gate]]
