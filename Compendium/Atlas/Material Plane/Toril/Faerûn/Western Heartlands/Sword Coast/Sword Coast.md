...
locations:
  - "[[Western Heartlands]]"
displayLink: "[[Sword Coast#The Sword Coast]]"
---
...
FROM "Compendium/NPCs" AND [[Sword Coast]]
SORT file.name ASC
>
>> [!example]- LOCATIONS
>>```dataview
LIST WITHOUT ID displayLink
FROM "Compendium/Atlas/Material Plane/Toril/Faerûn/Western Heartlands/Sword Coast" AND [[Sword Coast]]
...
>>```dataview
LIST WITHOUT ID displayLink
FROM "Session Notes" AND [[Sword Coast]]
