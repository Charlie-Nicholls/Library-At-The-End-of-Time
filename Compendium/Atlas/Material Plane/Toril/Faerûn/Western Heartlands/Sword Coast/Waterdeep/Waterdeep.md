...
locations:
  - "[[Sword Coast]]"
displayLink: "[[Waterdeep#Waterdeep]]"
---
...
FROM "Compendium/NPCs" AND [[Waterdeep]]
SORT file.name ASC
>
>> [!example]- LOCATIONS
>>```dataview
LIST WITHOUT ID displayLink
FROM "Compendium/Atlas/Material Plane/Toril/Faerûn/Western Heartlands/The Sword Coast/Waterdeep"  AND [[Waterdeep]]
